...
namespace Binner.Common.Barcode
{
    public class Labels
    {
        ...
        public static Image LabelITF14(Barcode Barcode, Bitmap img)
        {
            try
            {
        ...
        /// <param name="img">Image representation of the barcode without the labels</param>
        /// <returns>Image representation of the barcode with labels applied</returns>
        public static Image LabelGeneric(Barcode Barcode, Bitmap img)
        {
            try
            {
                Font font = Barcode.LabelFont;
        ...
        /// <param name="img">Image representation of the barcode without the labels</param>
        /// <returns>Image representation of the barcode with labels applied</returns>
        public static Image LabelEAN13(Barcode Barcode, Bitmap img)
        {
            try
            {
        ...
        /// <param name="img">Image representation of the barcode without the labels</param>
        /// <returns>Image representation of the barcode with labels applied</returns>
        public static Image LabelUPCA(Barcode Barcode, Bitmap img)
        {
            try
            {
