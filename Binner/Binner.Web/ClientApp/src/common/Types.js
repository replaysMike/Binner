...
export const PackageTypes = {
  ...
  // resistor/capacitor/diode types
  SMD201: { name: '201', alt: ['0201'], description: '0.6mm x 0.3mm (metric 603)', type: 'common' },
  SMD402: { name: '402', alt: ['0402'], description: '1.0mm x 0.5mm (metric 1005)', type: 'common' },
  SMD603: { name: '603', alt: ['0603'], description: '1.6mm x 0.8mm (metric 1608)', type: 'common' },
  SMD805: { name: '805', alt: ['0805'], description: '2.0mm x 1.25mm (metric 2012)', type: 'common' },
  SMD1206: { name: '1206', description: '3.2mm x 1.6mm (metric 3216)', type: 'common' },
  SMD1210: { name: '1210', description: '3.2mm x 2.5mm (metric 3225)', type: 'common' },
  SMD1812: { name: '1812', description: '4.5mm x 3.2mm (metric 4532)', type: 'basic' },
  SMD2010: { name: '2010', description: '5.0mm x 2.5mm (metric 5025)', type: 'basic' },
  SMD2512: { name: '2512', description: '6.3mm x 3.2mm (metric 6332)', type: 'basic' },
  SMD102: { name: '102', alt: ['0102'], description: '2.2mm x 1.1mm', type: 'basic' },
  SMD204: { name: '204', alt: ['0204'], description: '3.6mm x 1.4mm', type: 'basic' },
  SMD207: { name: '207', alt: ['0207'], description: '5.8mm x 2.2mm', type: 'basic' },
  SMD1008: { name: '1008', description: '2.5mm x 2.0mm (metric 2520)', type: 'basic' },
  SMD1806: { name: '1806', description: '4.5mm x 1.6mm (metric 4516)', type: 'basic' },
  SMD1825: { name: '1825', description: '4.5mm x 6.4mm (metric 4564)', type: 'basic' },
  SMD2920: { name: '2920', description: '7.4mm x 5.1mm (metric 7451)', type: 'basic' },
  SMD9005: { name: '9005', description: '0.3mm x 0.15mm (metric 3015)', type: 'basic' },
  SMD1005: { name: '1005', description: '0.4mm x 0.2mm (metric 402)', type: 'basic' },
  SMD2725: { name: '2725', description: '6.9mm x 6.3mm (metric 6833)', type: 'basic' },
  // led types
  SMD2835: { name: '2835', description: '2.8mm x 3.5mm', type: 'led' },
  SMD3014: { name: '3014', description: '3.0mm x 1.4mm', type: 'led' },
  SMD3030: { name: '3030', description: '3.0mm x 3.0mm', type: 'led' },
  SMD3528: { name: '3528', description: '3.5mm x 2.8mm', type: 'led' },
  SMD5050: { name: '5050', description: '5.0mm x 5.0mm', type: 'led' },
  SMD5630: { name: '5630', description: '5.6mm x 3.0mm', type: 'led' },
  SMD5730: { name: '5730', description: '5.7mm x 3.0mm', type: 'led' },
  SMD4020: { name: '4020', description: '4.0mm x 2.0mm', type: 'led' },
  SMD1010: { name: '1010', description: '1.0mm x 1.0mm', type: 'led' },
  SMD2323: { name: '2323', description: '2.3mm x 2.3mm', type: 'led' },
  SMD2420: { name: '2420', description: '2.4mm x 2.0mm', type: 'led' },
  SMD3623: { name: '3623', description: '3.6mm x 2.3mm', type: 'led' },
  SMD3535: { name: '3535', description: '3.5mm x 3.5mm', type: 'led' },
  SMD1414: { name: '1414', description: '1.4mm x 1.4mm', type: 'led' },
  SMD2020: { name: '2020', description: '2.0mm x 2.0mm', type: 'led' },
  SMD1113: { name: '1113', description: '1.1mm x 1.3mm', type: 'led' },
