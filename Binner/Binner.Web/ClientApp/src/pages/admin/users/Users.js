...
import { Table, Form, Segment, Button, Icon, Input, Popup, Confirm, Breadcrumb, Flag } from "semantic-ui-react";
import { fetchApi } from "../../../common/fetchApi";
import { InifiniteScrollTable } from "../../../components/InfiniteScrollTable";
import { AccountTypes, BooleanTypes, GetTypeName, GetTypeDropdown } from "../../../common/Types";
          ...
          <Button type="button" onClick={handleShowAdd} icon size="mini">
			...
			<Segment loading={loading} secondary>
              ...
              <Table.Row key={i} onClick={(e) => openUser(e, user)}>
                ...
                <Table.Cell>
									<Button size="mini" icon="delete" disabled={user.userId === 1} onClick={(e) => confirmDeleteOpen(e, user)} title={user.userId === 1 ? t('page.admin.users.canNotDeleteAdmin', "Can not delete master admin") : t('button.delete', "Delete")} />
                </Table.Cell>
              </Table.Row>
            ))}
				</InifiniteScrollTable>
