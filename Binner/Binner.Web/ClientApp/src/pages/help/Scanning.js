  ...
  return (
    <div className="help">
      ...
      <Segment raised>
        ...
        <p>
          If you own a handheld barcode scanner you can utilize it for importing orders, parts or scanning barcodes on your custom part bin labels.
          <br />
          Pages that feature this symbol{" "}
          <Image src="/image/barcode.png" width={35} height={35} className="barcode-support" style={{ display: "inline-block", margin: "0 5px" }} /> indicates
          there are barcode scanning features supported on that page.
          <br />
          <br />
          DigiKey and Mouser both label their parts using a combination of 2D (DotMatrix) and 1D (Code-128) barcodes. Each supplier offers different features
          and integrates directly with Binner.
        </p>
        ...
        <Segment>
          <h4>DigiKey</h4>
          <p>
            DigiKey uses different types of barcodes for it's various paperwork and labeling. Invoices use a standard code-128 barcode which can be scanned on
            the Order Import page.
            <br />
            <br />
          ...
          <p>
            On the <Link to="/import">Order Import</Link> page you can scan one of your past orders to import all parts in the order at once.
            <br />
            To do so, you will need the DigiKey packing list for your order. The invoice doesn't contain the barcodes you want, however you can type in the
          ...
          <p>
            The Sales Order number can be scanned (top right) to import the entire - <i>or parts of</i> an order. You can also scan the 2D DotMatrix barcodes
            which provide the same information.
          </p>
          <p>
            Additionally, each itemized part can be scanned in the packing list but this is only supported on the Add Inventory page. Note there is a barcode
            for both the part as well as a smaller barcode for its quantity.
          </p>
        </Segment>
