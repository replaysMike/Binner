        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProduceUnassociated = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PcbCost = table.Column<double>(type: "double precision", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectPcbProduceHistory_ProjectProduceHistory_ProjectProdu~",
            ...
            migrationBuilder.Sql("INSERT INTO dbo.\"Organizations\" (\"Name\", \"Description\", \"DateCreatedUtc\", \"DateModifiedUtc\") VALUES('Default', 'Default Organization', timezone('utc', now()), timezone('utc', now()));");
            migrationBuilder.Sql("UPDATE dbo.\"OAuthCredentials\" SET \"OrganizationId\" = 1");
            migrationBuilder.Sql("UPDATE dbo.\"OAuthRequests\" SET \"OrganizationId\" = 1");
            migrationBuilder.Sql("UPDATE dbo.\"Parts\" SET \"OrganizationId\" = 1");
            migrationBuilder.Sql("UPDATE dbo.\"PartSuppliers\" SET \"OrganizationId\" = 1");
            migrationBuilder.Sql("UPDATE dbo.\"PartTypes\" SET \"OrganizationId\" = 1");
            migrationBuilder.Sql("UPDATE dbo.\"Pcbs\" SET \"OrganizationId\" = 1");
            migrationBuilder.Sql("UPDATE dbo.\"PcbStoredFileAssignments\" SET \"OrganizationId\" = 1");
            migrationBuilder.Sql("UPDATE dbo.\"ProjectPartAssignments\" SET \"OrganizationId\" = 1");
            migrationBuilder.Sql("UPDATE dbo.\"ProjectPcbAssignments\" SET \"OrganizationId\" = 1");
            migrationBuilder.Sql("UPDATE dbo.\"Projects\" SET \"OrganizationId\" = 1");
            migrationBuilder.Sql("UPDATE dbo.\"StoredFiles\" SET \"OrganizationId\" = 1");
            migrationBuilder.Sql("UPDATE dbo.\"UserIntegrationConfigurations\" SET \"OrganizationId\" = 1");
            migrationBuilder.Sql("UPDATE dbo.\"UserLoginHistory\" SET \"OrganizationId\" = 1");
            migrationBuilder.Sql("UPDATE dbo.\"UserPrinterConfigurations\" SET \"OrganizationId\" = 1");
            migrationBuilder.Sql("UPDATE dbo.\"UserPrinterTemplateConfigurations\" SET \"OrganizationId\" = 1");
            migrationBuilder.Sql("UPDATE dbo.\"Users\" SET \"OrganizationId\" = 1");
            migrationBuilder.Sql("UPDATE dbo.\"UserTokens\" SET \"OrganizationId\" = 1");
        }
