...
namespace Binner.Data.Migrations.SqlServer.Migrations
{
    ...
    [Migration("20250707222647_AddGlobalPrefConfig")]
    partial class AddGlobalPrefConfig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Binner.Data.Model.UserBarcodeConfiguration", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("UserBarcodeConfigurationId"));
            ...
            modelBuilder.Entity("Binner.Data.Model.UserGlobalConfiguration", b =>
                {
                    b.Property<int>("UserGlobalConfigurationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("UserGlobalConfigurationId"));
                    ...
                    b.HasKey("UserGlobalConfigurationId");

                    b.HasIndex("UserId");

                    b.ToTable("UserGlobalConfigurations", "dbo");
                });
            ...
            modelBuilder.Entity("Binner.Data.Model.UserLocaleConfiguration", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("UserLocaleConfigurationId"));
            ...
            modelBuilder.Entity("Binner.Data.Model.UserPreferences", b =>
                {
            ...
            modelBuilder.Entity("Binner.Data.Model.UserGlobalConfiguration", b =>
                {
                    b.HasOne("Binner.Data.Model.User", "User")
                        .WithMany("UserGlobalConfigurations")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Binner.Data.Model.User", b =>
                {
                    ...
                    b.Navigation("UserGlobalConfigurations");
