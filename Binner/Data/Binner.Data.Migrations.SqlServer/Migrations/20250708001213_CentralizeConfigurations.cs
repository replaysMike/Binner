        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NexarEnabled = table.Column<bool>(type: "bit", nullable: false),
                    NexarClientId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NexarClientSecret = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TmeEnabled = table.Column<bool>(type: "bit", nullable: false),
                    TmeCountry = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TmeApplicationSecret = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TmeApiKey = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TmeApiUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TmeResolveExternalLinks = table.Column<bool>(type: "bit", nullable: false),
                    DateCreatedUtc = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "getutcdate()"),
                    DateModifiedUtc = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "getutcdate()"),
                    UserId = table.Column<int>(type: "int", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnableAutoPartSearch = table.Column<bool>(type: "bit", nullable: false),
                    EnableDarkMode = table.Column<bool>(type: "bit", nullable: false),
                    BarcodeEnabled = table.Column<bool>(type: "bit", nullable: false),
                    BarcodeIsDebug = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    BarcodePrefix2D = table.Column<string>(type: "nvarchar(max)", nullable: false),
