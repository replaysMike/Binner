...
using Binner.Legacy.Extensions;
...
namespace Binner.Legacy.StorageProviders
{
    public class BinnerFileStorageProvider : IStorageProvider
    {
        ...
        private IBinnerDb _db = new BinnerDbV7();
        ...
        public async Task<bool> DeletePartAsync(Part part, IUserContext? userContext)
        {
            ...
            {
                part.UserId = userContext?.UserId;
                var entity = (_db as BinnerDbV7)?.Parts
        ...
        public async Task<bool> DeletePartTypeAsync(PartType partType, IUserContext? userContext)
        {
            ...
            {
                partType.UserId = userContext?.UserId;
                var entity = (_db as BinnerDbV7)?.PartTypes
        ...
        public async Task<bool> DeleteProjectAsync(Project project, IUserContext? userContext)
        {
            ...
            {
                project.UserId = userContext?.UserId;
                var entity = (_db as BinnerDbV7)?.Projects
        ...
        public async Task<StoredFile?> GetStoredFileAsync(long storedFileId, IUserContext? userContext)
        {
            ...
            try
            {
                return ((_db as BinnerDbV7)?.StoredFiles)?.FirstOrDefault(x => x.StoredFileId.Equals(storedFileId) && x.UserId == userContext?.UserId);
            }
            finally
            {
                _dataLock.Release();
        ...
        public async Task<StoredFile?> GetStoredFileAsync(string filename, IUserContext? userContext)
        {
            ...
            try
            {
                return ((_db as BinnerDbV7)?.StoredFiles)?.FirstOrDefault(x => x.FileName.Equals(filename) && x.UserId == userContext?.UserId);
            }
            finally
            {
                _dataLock.Release();
        ...
        public async Task<ICollection<StoredFile>> GetStoredFilesAsync(long partId, StoredFileType? fileType, IUserContext? userContext)
        {
            ...
            try
            {
                return (_db as BinnerDbV7)?.StoredFiles
        ...
        public async Task<bool> DeleteStoredFileAsync(StoredFile storedFile, IUserContext? userContext)
        {
            ...
            {
                storedFile.UserId = userContext?.UserId;
                var entity = (_db as BinnerDbV7)?.StoredFiles
                    .FirstOrDefault(x => x.StoredFileId == storedFile.StoredFileId && x.UserId == storedFile.UserId);
                if (entity == null)
                    return false;
                var itemRemoved = (_db as BinnerDbV7)?.StoredFiles.Remove(entity);
                if (itemRemoved == true)
                {
                    var nextStoredFileId = ((_db as BinnerDbV7)?.StoredFiles.OrderByDescending(x => x.StoredFileId)
        ...
        public async Task<StoredFile> UpdateStoredFileAsync(StoredFile storedFile, IUserContext? userContext)
        {
            ...
            {
                storedFile.UserId = userContext?.UserId;
                var existingStoredFile = ((_db as BinnerDbV7)?.StoredFiles)
        ...
        public async Task<Model.Common.OAuthAuthorization> CreateOAuthRequestAsync(Model.Common.OAuthAuthorization authRequest, IUserContext? userContext)
        {
            ...
            try
            {
                ...
                (_db as BinnerDbV7)?.OAuthRequests.Add(oAuthRequest);
                _isDirty = true;
            }
            finally
            {
        ...
        public async Task<Model.Common.OAuthAuthorization> UpdateOAuthRequestAsync(Model.Common.OAuthAuthorization authRequest, IUserContext? userContext)
        {
            ...
            try
            {
                ...
                var existingOAuthRequest = ((_db as BinnerDbV7)?.OAuthRequests)
        ...
        public async Task<Pcb?> GetPcbAsync(long pcbId, IUserContext? userContext)
        {
            ...
            try
            {
                return ((_db as BinnerDbV7)?.Pcbs)?.FirstOrDefault(x => x.PcbId == pcbId && x.UserId == userContext?.UserId);
            }
            finally
            {
                _dataLock.Release();
        ...
        public async Task<ICollection<Pcb>> GetPcbsAsync(long projectId, IUserContext? userContext)
        {
            ...
            try
            {
                ...
                var assignments = (_db as BinnerDbV7)?.ProjectPcbAssignments
                    .Where(x => x.ProjectId == projectId && x.UserId == userContext?.UserId)
                    .ToList() ?? new List<ProjectPcbAssignment>();

                foreach (var assignment in assignments)
                {
                    var pcb = (_db as BinnerDbV7)?.Pcbs.FirstOrDefault(x => x.PcbId == assignment.PcbId);
                    if (pcb != null)
                        pcbs.Add(pcb);
                }
                return pcbs;
        ...
        public async Task<Pcb> UpdatePcbAsync(Pcb pcb, IUserContext? userContext)
        {
            ...
            {
                pcb.UserId = userContext?.UserId;
                var existingPcb = ((_db as BinnerDbV7)?.Pcbs)
        ...
        public async Task<bool> DeletePcbAsync(Pcb pcb, IUserContext? userContext)
        {
            ...
            try
            {
                ...
                var pcbEntity = (_db as BinnerDbV7)?.Pcbs
                    .FirstOrDefault(x => x.PcbId == pcb.PcbId && x.UserId == pcb.UserId);
                if (pcbEntity == null)
                    return false;

                var itemRemoved = (_db as BinnerDbV7)?.Pcbs.Remove(pcbEntity);
                if (itemRemoved == true)
                {
                    var nextPcbId = ((_db as BinnerDbV7)?.Pcbs.OrderByDescending(x => x.PcbId)
                        .Select(x => x.PcbId)
                        .FirstOrDefault() ?? 0);
                    nextPcbId++;
        ...
        public async Task<PcbStoredFileAssignment?> GetPcbStoredFileAssignmentAsync(long pcbStoredFileAssignmentId, IUserContext? userContext)
        {
            ...
            try
            {
                return ((_db as BinnerDbV7)?.PcbStoredFileAssignments)?.FirstOrDefault(x => x.PcbStoredFileAssignmentId == pcbStoredFileAssignmentId && x.UserId == userContext?.UserId);
            }
            finally
            {
                _dataLock.Release();
        ...
        public async Task<ICollection<PcbStoredFileAssignment>> GetPcbStoredFileAssignmentsAsync(long pcbId, IUserContext? userContext)
        {
            ...
            try
            {
                return (_db as BinnerDbV7)?.PcbStoredFileAssignments
        ...
        public async Task<PcbStoredFileAssignment> AddPcbStoredFileAssignmentAsync(PcbStoredFileAssignment assignment, IUserContext? userContext)
        {
            ...
            try
            {
                ...
                (_db as BinnerDbV7)?.PcbStoredFileAssignments.Add(assignment);
                _isDirty = true;
            }
            finally
            {
        ...
        public async Task<PcbStoredFileAssignment> UpdatePcbStoredFileAssignmentAsync(PcbStoredFileAssignment assignment, IUserContext? userContext)
        {
            ...
            {
                assignment.UserId = userContext?.UserId;
                var existingPcbStoredFileAssignment = ((_db as BinnerDbV7)?.PcbStoredFileAssignments)
        ...
        public async Task<bool> RemovePcbStoredFileAssignmentAsync(PcbStoredFileAssignment assignment, IUserContext? userContext)
        {
            ...
            try
            {
                ...
                if (assignmentEntity == null)
                    return false;
                var itemRemoved = (_db as BinnerDbV7)?.PcbStoredFileAssignments.Remove(assignmentEntity);
                if (itemRemoved == true)
                {
                    var nextPcbStoredFileAssignmentId = ((_db as BinnerDbV7)?.PcbStoredFileAssignments.OrderByDescending(x => x.PcbStoredFileAssignmentId)
        ...
        public async Task<ProjectPartAssignment?> GetProjectPartAssignmentAsync(long projectPartAssignmentId, IUserContext? userContext)
        {
            ...
            try
            {
                return ((_db as BinnerDbV7)?.ProjectPartAssignments)?.FirstOrDefault(x => x.ProjectPartAssignmentId == projectPartAssignmentId && x.UserId == userContext?.UserId);
            }
            finally
            {
                _dataLock.Release();
        ...
        public async Task<ICollection<ProjectPartAssignment>> GetPartAssignmentsAsync(long partId, IUserContext? userContext)
        {
            ...
            try
            {
                return (_db as BinnerDbV7)?.ProjectPartAssignments
        ...
        public async Task<ProjectPartAssignment?> GetProjectPartAssignmentAsync(long projectId, long partId, IUserContext? userContext)
        {
            ...
            try
            {
                return ((_db as BinnerDbV7)?.ProjectPartAssignments)?.FirstOrDefault(x => x.ProjectId == projectId && x.PartId == partId && x.UserId == userContext?.UserId);
            }
            finally
            {
                _dataLock.Release();
        ...
        public async Task<ProjectPartAssignment?> GetProjectPartAssignmentAsync(long projectId, string partName, IUserContext? userContext)
        {
            ...
            try
            {
                return ((_db as BinnerDbV7)?.ProjectPartAssignments)?.FirstOrDefault(x => x.ProjectId == projectId && x.PartName != null && x.PartName.Equals(partName, StringComparison.InvariantCultureIgnoreCase) && x.UserId == userContext?.UserId);
            }
            finally
            {
                _dataLock.Release();
        ...
        public async Task<ProjectPartAssignment> AddProjectPartAssignmentAsync(ProjectPartAssignment assignment, IUserContext? userContext)
        {
            ...
            try
            {
                ...
                (_db as BinnerDbV7)?.ProjectPartAssignments.Add(assignment);
                _isDirty = true;
            }
            finally
            {
        ...
        public async Task<ProjectPartAssignment> UpdateProjectPartAssignmentAsync(ProjectPartAssignment assignment, IUserContext? userContext)
        {
            ...
            {
                assignment.UserId = userContext?.UserId;
                var existingProjectPartAssignment = ((_db as BinnerDbV7)?.ProjectPartAssignments)
        ...
        public async Task<bool> RemoveProjectPartAssignmentAsync(ProjectPartAssignment assignment, IUserContext? userContext)
        {
            ...
            try
            {
                ...
                if (assignmentEntity == null)
                    return false;
                var itemRemoved = (_db as BinnerDbV7)?.ProjectPartAssignments.Remove(assignmentEntity);
                if (itemRemoved == true)
                {
                    var nextProjectPartAssignmentId = ((_db as BinnerDbV7)?.ProjectPartAssignments.OrderByDescending(x => x.ProjectPartAssignmentId)
        ...
        public async Task<ProjectPcbAssignment?> GetProjectPcbAssignmentAsync(long projectPcbAssignmentId, IUserContext? userContext)
        {
            ...
            try
            {
                return ((_db as BinnerDbV7)?.ProjectPcbAssignments)?.FirstOrDefault(x => x.ProjectPcbAssignmentId == projectPcbAssignmentId && x.UserId == userContext?.UserId);
            }
            finally
            {
                _dataLock.Release();
        ...
        public async Task<ICollection<ProjectPcbAssignment>> GetProjectPcbAssignmentsAsync(long projectId, IUserContext? userContext)
        {
            ...
            try
            {
                return (_db as BinnerDbV7)?.ProjectPcbAssignments
                    .Where(x => x.ProjectId == projectId && x.UserId == userContext?.UserId)
                    .ToList() ?? new List<ProjectPcbAssignment>();
            }
            finally
        ...
        public async Task<ProjectPcbAssignment> AddProjectPcbAssignmentAsync(ProjectPcbAssignment assignment, IUserContext? userContext)
        {
            ...
            try
            {
                ...
                (_db as BinnerDbV7)?.ProjectPcbAssignments.Add(assignment);
                _isDirty = true;
            }
            finally
            {
        ...
        public async Task<ProjectPcbAssignment> UpdateProjectPcbAssignmentAsync(ProjectPcbAssignment assignment, IUserContext? userContext)
        {
            ...
            {
                assignment.UserId = userContext?.UserId;
                var existingProjectPcbAssignment = ((_db as BinnerDbV7)?.ProjectPcbAssignments)
        ...
        public async Task<bool> RemoveProjectPcbAssignmentAsync(ProjectPcbAssignment assignment, IUserContext? userContext)
        {
            ...
            try
            {
                ...
                if (assignmentEntity == null)
                    return false;
                var itemRemoved = (_db as BinnerDbV7)?.ProjectPcbAssignments.Remove(assignmentEntity);
                if (itemRemoved == true)
                {
        ...
        public async Task<PartSupplier> AddPartSupplierAsync(PartSupplier partSupplier, IUserContext? userContext)
        {
            ...
            try
            {
                ...
                (_db as BinnerDbV7)?.PartSuppliers.Add(partSupplier);
                _isDirty = true;
            }
            finally
            {
        ...
        public async Task<PartSupplier?> GetPartSupplierAsync(long partSupplierId, IUserContext? userContext)
        {
            ...
            try
            {
                return ((_db as BinnerDbV7)?.PartSuppliers)?.FirstOrDefault(x => x.PartSupplierId.Equals(partSupplierId) && x.UserId == userContext?.UserId);
            }
            finally
            {
                _dataLock.Release();
        ...
        public async Task<ICollection<PartSupplier>> GetPartSuppliersAsync(long partId, IUserContext? userContext)
        {
            ...
            try
            {
                return (_db as BinnerDbV7)?.PartSuppliers
                    .Where(x => x.PartId.Equals(partId))
                    .Where(x => x.UserId == userContext?.UserId)
        ...
        public async Task<PartSupplier> UpdatePartSupplierAsync(PartSupplier partSupplier, IUserContext? userContext)
        {
            ...
            {
                partSupplier.UserId = userContext?.UserId;
                var existingPartSupplier = ((_db as BinnerDbV7)?.PartSuppliers)
        ...
        public async Task<bool> DeletePartSupplierAsync(PartSupplier partSupplier, IUserContext? userContext)
        {
            ...
            {
                partSupplier.UserId = userContext?.UserId;
                var entity = (_db as BinnerDbV7)?.PartSuppliers
                    .FirstOrDefault(x => x.PartSupplierId == partSupplier.PartSupplierId && x.UserId == partSupplier.UserId);
                if (entity == null)
                    return false;
                var itemRemoved = (_db as BinnerDbV7)?.PartSuppliers.Remove(entity);
                if (itemRemoved == true)
                {
                    var nextPartSupplierId = ((_db as BinnerDbV7)?.PartSuppliers.OrderByDescending(x => x.PartSupplierId)
                ...
                try
                {
                    using (var stream = File.OpenRead(_config.Filename))
                    {
                        ...
                        _primaryKeyTracker = new PrimaryKeyTracker(new Dictionary<string, long>
                        {
                            ...
                            { nameof(StoredFile), Math.Max((_db as BinnerDbV7)?.StoredFiles.OrderByDescending(x => x.StoredFileId).Select(x => x.StoredFileId).FirstOrDefault() ?? 0 + 1, 1) },
                            { nameof(OAuthRequest), Math.Max((_db as BinnerDbV7)?.OAuthRequests.OrderByDescending(x => x.OAuthRequestId).Select(x => x.OAuthRequestId).FirstOrDefault() ?? 0 + 1, 1) },
                            { nameof(Pcb), Math.Max((_db as BinnerDbV7)?.OAuthRequests.OrderByDescending(x => x.OAuthRequestId).Select(x => x.OAuthRequestId).FirstOrDefault() ?? 0 + 1, 1) },
                            { nameof(PcbStoredFileAssignment), Math.Max((_db as BinnerDbV7)?.OAuthRequests.OrderByDescending(x => x.OAuthRequestId).Select(x => x.OAuthRequestId).FirstOrDefault() ?? 0 + 1, 1) },
                            { nameof(ProjectPartAssignment), Math.Max((_db as BinnerDbV7)?.OAuthRequests.OrderByDescending(x => x.OAuthRequestId).Select(x => x.OAuthRequestId).FirstOrDefault() ?? 0 + 1, 1) },
                            { nameof(ProjectPcbAssignment), Math.Max((_db as BinnerDbV7)?.OAuthRequests.OrderByDescending(x => x.OAuthRequestId).Select(x => x.OAuthRequestId).FirstOrDefault() ?? 0 + 1, 1) },
                            { nameof(PartSupplier), Math.Max((_db as BinnerDbV7)?.PartSuppliers.OrderByDescending(x => x.PartSupplierId).Select(x => x.PartSupplierId).FirstOrDefault() ?? 0 + 1, 1) },
                        });
                    }
                }
                catch (Exception ex)
        ...
        private IBinnerDb LoadDatabaseByVersion(BinnerDbVersion version, byte[] bytes)
        {
            ...
            try
            {
                db = version.Version switch
                {
                    ...
                    BinnerDbV1.VersionNumber => new BinnerDbV7(_serializer.Deserialize<BinnerDbV1>(bytes, SerializationOptions, new PropertyVersion("BinnerDbV4", "BinnerDbV5", "BinnerDbV6", "BinnerDbV7")), (upgradeDb) => BuildChecksum(upgradeDb)),
                    // Version 2 (upgrade required)
                    BinnerDbV2.VersionNumber => new BinnerDbV7(_serializer.Deserialize<BinnerDbV2>(bytes, SerializationOptions, new PropertyVersion("BinnerDbV4", "BinnerDbV5", "BinnerDbV6", "BinnerDbV7")), (upgradeDb) => BuildChecksum(upgradeDb)),
                    // Version 3 (upgrade required)
                    BinnerDbV3.VersionNumber => new BinnerDbV7(_serializer.Deserialize<BinnerDbV3>(bytes, SerializationOptions, new PropertyVersion("BinnerDbV4", "BinnerDbV5", "BinnerDbV6", "BinnerDbV7")), (upgradeDb) => BuildChecksum(upgradeDb)),
                    // Version 4 (upgrade required)
                    BinnerDbV4.VersionNumber => new BinnerDbV7(_serializer.Deserialize<BinnerDbV4>(bytes, SerializationOptions, new PropertyVersion("BinnerDbV5", "BinnerDbV6", "BinnerDbV7")), (upgradeDb) => BuildChecksum(upgradeDb)),
                    // Version 5 (upgrade required)
                    BinnerDbV5.VersionNumber => new BinnerDbV7(_serializer.Deserialize<BinnerDbV5>(bytes, SerializationOptions, new PropertyVersion("BinnerDbV6", "BinnerDbV7")), (upgradeDb) => BuildChecksum(upgradeDb)),
                    // Version  (upgrade required)
                    BinnerDbV6.VersionNumber => new BinnerDbV7(_serializer.Deserialize<BinnerDbV6>(bytes, SerializationOptions, new PropertyVersion("BinnerDbV7")), (upgradeDb) => BuildChecksum(upgradeDb)),
                    // Current version
                    BinnerDbV7.VersionNumber => _serializer.Deserialize<BinnerDbV7>(bytes, SerializationOptions),
        ...
        private async Task SaveDatabaseAsync(bool requireLock = true)
        {
            ...
            try
            {
                ...
                WriteDbVersion(stream, new BinnerDbVersion(BinnerDbV7.VersionNumber, BinnerDbV7.VersionCreated));
