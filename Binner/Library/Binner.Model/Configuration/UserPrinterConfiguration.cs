...
namespace Binner.Model.Configuration
{
    ...
    /// </summary>
    public class UserPrinterConfiguration
    {
        /// <summary>
        /// Associated user
        /// </summary>
        ...
        /// <summary>
        /// Printer label line templates
        /// </summary>
        public ICollection<UserPrinterTemplateConfiguration> UserPrinterTemplateConfigurations { get; set; } = new List<UserPrinterTemplateConfiguration>();
    }
}
