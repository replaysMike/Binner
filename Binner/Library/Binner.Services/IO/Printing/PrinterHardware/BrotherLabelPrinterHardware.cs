...
namespace Binner.Services.IO.Printing
{
    ...
    public class BrotherLabelPrinterHardware : ILabelPrinterHardware
    {
        ...
        public BrotherLabelPrinterHardware(ILoggerFactory loggerFactory, IBarcodeGenerator barcodeGenerator, IPrinterSettings printerSettings, ISystemHubProxy systemHubProxy)
        {
